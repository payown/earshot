...
enum EpisodeAction: String, CaseIterable, Identifiable, Codable {
    ...
    var label: String {
        ...
        case .refreshAudio: return "Refresh episode audio"
...
let defaultEpisodeActions: [EpisodeAction] = [
    ...
    .exportTranscript,
    .exportAudio,
    // Recovery escape hatch for publishers that replace broken media without
    // changing its GUID, date, URL, or byte length.
    .refreshAudio,
