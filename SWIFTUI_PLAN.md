...
| 6 | Queue — reorder/remove/move, groups, gapless | PRD 5.3 | #341 | [~] | Domain (QueueLogic, 20 tests), repository (QueueRepository, 13 tests), and QueueScreen UI done + VoiceOver-reviewed (e9a17ad, 361879a, 0eb185d). 76 tests green. Remaining: gapless preload + queue-change invalidation in PlayerService. Queue expiration/Recently Expired stays in F8. |
